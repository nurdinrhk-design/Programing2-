...
<html>
    <head>
        ...
        <title>Data Mata Kuliah - Web Admin Nurdin</title>
            ...
            <div class="main-content">
                <div class="sidebar">
                    <div class="menu-group">
                        ...
                        <a href="MataKuliahController" class="active"><i class="fa-solid fa-book"></i> Mata Kuliah</a>
                    </div>
                    <div class="menu-group">
                        <h4>Transaksi</h4>
                ...
                <div class="content">
                    ...
                    <div class="tabel-container">
                        <table>
                            ...
                            <tbody>
                                <%
                                    List<MataKuliah> daftar = (List<MataKuliah>) request.getAttribute("daftarMataKuliah");
                                ...
                                %>
                                <tr>
                                    <td colspan="4" style="text-align: center; padding: 20px;">Belum ada data mata kuliah.</td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
